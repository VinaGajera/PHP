                            ...
                            while($row = mysqli_fetch_assoc($result))
                            {
                                ...
                                $c_type=$row["c_type"];
                                    ...
                                    echo '</td>';
                                        ...
                                        <td>'.$c_type.'</td>  
                                        <td><a class="btn btn-primary" href="complaindetailcomplete.php?complaintid='.$complaint_id.'" role="button">View Detail</a>        
                                                 </tr>';            
                            }
