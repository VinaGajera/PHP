...
<body>
                ...
                <tbody>
                      ...
                      echo'  <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="3">Complaint is Running mode</td>
                        </tr>
                        <tr>
                            <th scope="row">Action</th>
                            <td colspan="2" style="text-align:right"> <button type="button" class="btn btn-primary"
                            ...
                            <td><button type="button" class="btn btn-primary" data-toggle="modal"
                                ...
                                &nbsp;<a href="runningprocess.php" class="btn btn-primary">Back</a></td></td>
                                                    </tr>';
                            }
                        }
                        ?>
        ...
        <div class="modal fade" id="viewuserdetail" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <center>
                    <img src="../../USER_WORK/'.$user_image.'" alt="" height="100px" width="100px" style="
                    border-radius:50%;
                    margin:20px 0px; 
                    ">
                    </center>
                        <div class="row">
                            <div class="col">
                                <label style="color:red;font-weight:700;"for="exampleFormControlInput1">Complaint Number</label>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <label class="form-check-label" for="defaultCheck1"> CompleteProcess
                                    </label>
                                </div>
                            </div>
                        </div>
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        echo $inprocess=$_POST['inprocess'];
        if($inprocess==1)
        {
