                                ...
                                while($rrow = mysqli_fetch_assoc($r))
                   {
                       ...
                       if($r_id==$complaint_id)
                       {
                        echo '<td style="text-align:right"> ';
                                ...
                                echo '&nbsp;<a href="completeprocess.php" class="btn btn-primary">Back</a>
                               </td>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <label class="form-check-label" for="defaultCheck1"> Futhur Start the process
                                    </label>
                                </div>
                            </div>
                        </div>
            ...
            if (mysqli_query($conn, $sql)) {
                ...
                while($row = mysqli_fetch_assoc($result))
                {
                    ...
                    while($row2 = mysqli_fetch_assoc($result2))
                    {
                        ...
                        $sql2="INSERT INTO `notify` ( `sender_user_id`, `complaint_id`, `sender_user_role`, `msg`, `reciver_id`, `msg_recive`, `send_msg`, `status`) VALUES('$sender_user_id', '$complaint_get_id', 'admin', '$msg', '$recever_user_id', 'user', current_timestamp(), '0')";
