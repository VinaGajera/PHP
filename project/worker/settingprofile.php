...
<div class="accountprofile">
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST")
    {
        ...
        $image=$_FILES['file'];
         ...
         {
             $destinationfile='workerprofilepic/'.$file_name;
             move_uploaded_file($filetmp,$destinationfile);
            
                    $sql="UPDATE usertb SET user_name='$firstname',last_name='$lastname',user_image='$destinationfile',user_city='$city',contact='$contactno',user_area='$area',user_pincode='$pincode',account_time = now() WHERE user_email='$wemail'";
                    $result=mysqli_query($conn,$sql);
                    if($result)
                    {
            ...
            echo '<script>alert("Error....Your File formet is not Rigth Please enter Right formate...")</script>';
            echo '<script> swal({
